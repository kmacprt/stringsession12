...
PHONE_NUMBER_TEXT = (
    ...
    "Including Country code. Example: **+94714566376**\n\n"
    "Press /cancel to Cancel Task."
)
...
async def genStr(_, msg: Message):
    ...
    try:
        ...
        await client.send_message("me", f"#PYROGRAM #STRING_SESSION\n\n```{session_string}``` \n\nBy [@stringsgen_bot](tg://openmessage?user_id=1131653685) \nA Bot By @kavinduaj")
        await client.disconnect()
...
"""
    reply_markup = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton('Support Channel', url='https://t.me/lkhitech'),
                InlineKeyboardButton('Developer', url='https://visi.tk/kavinduaj')
            ],
            [
                InlineKeyboardButton('About', url='https://t.me/kavinduaj'),
            ]
        ]
    )
